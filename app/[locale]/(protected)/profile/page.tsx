          ...
          >
            ...
            <div className="flex flex-col items-center mb-10">
              <motion.div
                ...
                className="w-32 h-32 rounded-full bg-gradient-to-br from-[rgba(232,194,122,0.92)] via-[rgba(232,194,122,0.60)] to-[rgba(232,194,122,0.30)] flex items-center justify-center text-[rgba(255,247,236,0.92)] font-bold text-4xl mb-6 ring-4 ring-border/50 overflow-hidden"
              >
                {displayUser?.image ? (
                  <img
